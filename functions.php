...
add_action('wp_enqueue_scripts' , 'load_css', '', time());
...
add_action('wp_enqueue_scripts' , 'load_js', '', time());
...
function my_shortcodes($atts, $content =null ,$tag= ''){
...
add_shortcode('latest_cars', 'my_shortcodes');